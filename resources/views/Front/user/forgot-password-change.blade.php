                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            <form action="{{route('resetnew.password')}}" method="post">
                             @csrf
                                <div class="form-group">
                                    <label>New Password</label>
                                    <input class="au-input au-input--full" type="password" name="reset_new_password" placeholder="New Password">
                                    <code>@error('reset_new_password')
                                     {{$message}}
                                    @enderror   
                                     </code>
                                </div>
                               
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" name="submit">Update</button>
