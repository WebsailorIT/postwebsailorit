...
@section('user_my_profile','active')
                        	...
                        	<div class="row gy-4">	
	                            <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    ...
	                                    <input type="text" name="user_fullname" class="form-control" id="fullname" placeholder="Your Full Name" value="{{$user_fullname}}">
	                                </div>
	                            </div>
	                            <!--end col-->
	                            <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    ...
	                                    <input type="text" name="user_companyname" class="form-control" id="companyname" placeholder="Company Name" value="{{$user_companyname}}">
	                                </div>
	                            </div>
	                            <!--end col-->
	                            <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    <label for="companypos" class="form-label">Your Position</label>
	                                    <input type="text" name="company_position" class="form-control" id="companypos" placeholder="Company Position" value="{{$company_position}}">
	                                </div>
	                            </div>
	                            <!--end col-->
	                            <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    ...
	                                    <input type="email" name="user_busiemail" class="form-control" id="businessemail" placeholder="Business Email" value="{{$user_busiemail}}">
	                                </div>
	                            </div>
	                             ...
	                             <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    ...
	                                    <input type="text" name="user_busiphone" class="form-control" id="businessphone" placeholder="Business Phone" value="{{$user_busiphone}}">
	                                </div>
	                            </div>
	                             <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    <label for="businessphone" class="form-label">Website </label>
	                                    <input type="text" name="user_website" class="form-control" id="businessphone" placeholder="Business Phone" value="{{$user_website}}">
	                            ...
	                            <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    ...
	                                    <img src="{{asset('storage/media/user/'.$cover_image)}}" alt="{{$user_companyname}}" width="100px" style=" border: 1px solid #ccc; padding: 5px; margin-top: 5px; " />
	                                </div>
	                                	<code>
											@error('cover_image')
											 {{$message}}
	                            ...
	                            <div class="col-lg-12">
	                                <div>
	                                    ...
	                                    <textarea class="form-control" name="business_tags" id="businesstags" rows="1" placeholder="Business Tags">{{$business_tags}}</textarea>
	                            ...
	                            <div class="col-lg-12">
	                                <div>
	                                    ...
	                                    <textarea class="form-control" name="conpany_details" id="companydetails" rows="3" placeholder="Business Detials">{{$conpany_details}}</textarea>
                        ...
                        <form action="{{route('profile.insert')}}" method="post" enctype="multipart/form-data">
                        	...
                        	<div class="row gy-4">	
	                            <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    <label for="fullname" class="form-label">Full Name</label>
	                                    <input type="text" name="user_fullname" class="form-control" id="fullname" placeholder="Your Full Name">
	                                </div>
	                            </div>
	                            <!--end col-->
	                            <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    <label for="companyname" class="form-label">Business Name</label>
	                                    <input type="text" name="user_companyname" class="form-control" id="companyname" placeholder="Company Name">
	                                </div>
	                            </div>
	                            <!--end col-->
	                            <div class="col-xxl-3 col-md-6">
	                            ...
	                            <div class="col-xxl-3 col-md-6">
	                                <div>
	                                    <label for="businessemail" class="form-label">Business Email</label>
	                                    <input type="email" name="user_busiemail" class="form-control" id="businessemail" placeholder="Business Email">
	                                </div>
	                            </div>
