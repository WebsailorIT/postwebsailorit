                            ...
                            <form action="{{route('reset.password')}}" method="post">
                             @csrf
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" name="forgot_email" placeholder="Email Address">
                                    <code>@error('forgot_email')
                                     {{$message}}
                                    @enderror   
                                     </code>
                                </div>
                               
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" name="submit">Reset Password</button>
