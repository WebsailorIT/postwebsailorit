                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('posts_select')">
                         ...
                         <li class="@yield('user_my_profile')">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <div class="form-header" action="" method="POST">
                               Hi, <b style="text-transform:capitalize;margin:0 10px;">{{session('FRONT_USER_NAME')}}</b> Welcome to Your Account
                            </div>
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">{{session('FRONT_USER_NAME')}}</a>
                                        </div>
